...
const getTotal = async () => {
    ...
    let value = _collectives.reduce((accumulator, item) => accumulator.plus(new BN(item.value.totalPillarMinted)), new BN(0)).toNumber();
    return value;
};
